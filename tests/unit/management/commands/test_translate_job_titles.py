...
class CommandTests(TestCase):
    ...
    def test_adds_translations_only_where_missing(self, mock_file):
        ...
        self.assertEquals(JobTitle.objects.filter_across_languages(name="Personalberater").count(), 0)
        self.assertEquals(JobTitle.objects.filter_across_languages(name="Kundenassistent Better Translation").count(), 1)
    ...
    def test_overwrites_existing_translations_when_forced(self, mock_file):
        ...
        self.assertEquals(JobTitle.objects.filter_across_languages(name="Personalberater").count(), 1)
