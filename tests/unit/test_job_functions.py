...
class JobFunctionViewTestCase(AuthenticatedTestCase):
    def setUp(self) -> None:
        ...
        vonq_job_category = VonqJobCategory.objects.create(
            mapi_id=1,
            name="Whatever"
        )
...
class JobFunctionTreeStructureTestCase(AuthenticatedTestCase):
    def setUp(self):
        ...
        self.engineering = JobFunction.objects.create(name="Engineering", vonq_taxonomy_value_id=vonq_job_category.id)
        ...
        self.construction = JobFunction.objects.create(name="Construction", vonq_taxonomy_value_id=vonq_job_category.id)
